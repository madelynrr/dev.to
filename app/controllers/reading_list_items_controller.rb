class ReadingListItemsController < ApplicationController
  # index action calling on these helper methods and passing an instance variable set to true to the view (the helper methods are creating an algolia search key and setting the view to either archived or valid)
  def index
