class ReadingList
  # attr_accesssor allows access to read or write to the @user variable
  attr_accessor :user
  ...
  # where the user meeds certain criteria defined in a helper method. I believe this returns the list of
  ...
  # Helper method that filters user reactions/reactions based on them belonging to a user,
  # being associated with an article AND being part of a reading list.
