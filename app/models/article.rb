class Article < ApplicationRecord
  ...
  # allows article to access user model's name/username attribute
  delegate :name, to: :user, prefix: true
  delegate :username, to: :user, prefix: true

  # tells database what an article belongs to, must belong to user, optionally to job opp, organization, and collection
  belongs_to :user
  ...
  # aliases comments, profile_pins, notifications, and notification_subscriptions, also adds inverses of theses aliases to save a database call for the article to which they belong
  # adds dependent delete all/destroy for notifications/notification_subscriptions, and buffer_updates
  ...
  # run these helper methods after saving
  ...
  # setting scopes for published status
  # setting scope/helper methids for sql queries
