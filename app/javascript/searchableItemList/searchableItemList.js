...
export function performInitialSearch({
  ...
  index.search('', searchOptions).then(result => {
    component.setState({
      ...
      index,
      // set the index in the component state, to be retrieved later
      itemsLoaded: true,
      // show the button if the number of total results is greater than the number of results for the current page
